...
DATA APPS(
   ...
   *IF '30jun2019'd < ApplicationEnterDate < '01aug2019'd;
	IF '20mar2022'd < ApplicationEnterDate < '26apr2022'd;
...
DATA INELIG;   
	...
	IF DateFiled NE '.' AND DateFiled < '26apr2019'd then delete;
RUN;
...
PROC IMPORT 
	DATAFILE = 
	"\\mktg-app01\E\Production\Master Files and Instructions\FBXSMOCC_Offers -20220407.xlSx" /*Change 04262022*/
...
DATA _NULL_;
	SET FINALMLA;
	FILE "\\mktg-app01\E\Production\MLA\MLA-INput files TO WEBSITE\MOCC_20220426.txt";
...
FILENAME MLA1
"\\mktg-app01\E\Production\MLA\MLA-Output files FROM WEBSITE\MLA_5_12_MOCC_20220426.txt";
