...
DATA 
	...
	*** ASSIGN ID MACRO VARIABLES -------------------------------- ***;
	CALL SYMPUT ('TUD_ID', 'MOCC_05.2_2022');

	*** ASSIGN DATA FILE MACRO VARIABLE -------------------------- ***;
	
	CALL SYMPUT ('FINALEXPORTFLAGGED', 
		'\\mktg-app01\E\Production\2022\05_May_2022\FBXSCC\5.2\MOCC_20220429FLAGGED.txt');
	CALL SYMPUT ('FINALEXPORTDROPPED', 
		'\\mktg-app01\E\Production\2022\05_May_2022\FBXSCC\5.2\MOCC_20220429FINAL.txt');
	CALL SYMPUT ('EXPORTMLA', 
		'\\mktg-app01\E\Production\MLA\MLA-INPUT FILES TO WEBSITE\MOCC_20220429.txt');
	CALL SYMPUT ('FINALEXPORTED', 
		'\\mktg-app01\E\Production\2022\05_May_2022\FBXSCC\5.2\MOCC_20220429FINAL_JQ.cSv');
	CALL SYMPUT ('FINALEXPORTHH', 
		'\\mktg-app01\E\Production\2022\05_May_2022\FBXSCC\5.2\MOCC_20220429FINAL_JQ.txt');
RUN;
...
DATA APPS(
   ...
   *IF '30jun2019'd < ApplicationEnterDate < '01aug2019'd;
	IF '23mar2022'd < ApplicationEnterDate < '29apr2022'd;
...
DATA INELIG;   
	...
	IF DateFiled NE '.' AND DateFiled < '29apr2019'd then delete;
RUN;
...
PROC IMPORT 
	DATAFILE = 
	"\\mktg-app01\E\Production\Master Files and Instructions\FBXSMOCC_Offers -20220428.xlSx" /*Change 04292022*/
...
DATA _NULL_;
	SET FINALMLA;
	FILE "\\mktg-app01\E\Production\MLA\MLA-INput files TO WEBSITE\MOCC_20220429.txt";
...
FILENAME MLA1
"\\mktg-app01\E\Production\MLA\MLA-Output files FROM WEBSITE\MLA_5_12_MOCC_20220429.txt";
