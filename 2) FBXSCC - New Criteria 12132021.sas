...
DATA 
	...
	*** ASSIGN DATA FILE MACRO VARIABLE -------------------------- ***;
	...
	CALL SYMPUT ('FINALEXPORTFLAGGED', 
		'\\mktg-app01\E\Production\2022\02_February_2022\FBXSCC\TEST\FBXS_CC_20220107FLAGGED.txt');
	CALL SYMPUT ('FINALEXPORTDROPPED', 
		'\\mktg-app01\E\Production\2022\02_February_2022\FBXSCC\TEST\FBXS_CC_20220107FINAL.txt');
	CALL SYMPUT ('EXPORTMLA', 
		'\\mktg-app01\E\Production\MLA\MLA-INPUT FILES TO WEBSITE\FBCC_20220107.txt');
	CALL SYMPUT ('FINALEXPORTED', 
		'\\mktg-app01\E\Production\2022\02_February_2022\FBXSCC\TEST\FBXS_CC_20220107FINAL_JQ.csv');
	CALL SYMPUT ('FINALEXPORTHH', 
		'\\mktg-app01\E\Production\2022\02_February_2022\FBXSCC\TEST\FBXS_CC_20220107FINAL_JQ.txt');
RUN;

*** NEW TCI DATA - RETAIL AND AUTO ------------------------------- ***;
PROC IMPORT 
	DATAFILE = 
		"\\mktg-app01\E\Production\2022\02_February_2022\FBXSCC\TEST\XS_Mail_Pull.xlsx" 
...
DATA MERGED_L_B2; /* FLAG FOR BAD DLQATB */
	...
	*IF TIMES30 = "." THEN TIMES30 = 0;
	...
	IF LAST12_60 > 1 OR RECENT6_60 > 0 THEN OLD_DLQ_FLAG = "X";
...
DATA _NULL_;
	SET FINALMLA;
	FILE "\\mktg-app01\E\Production\MLA\MLA-INput files TO WEBSITE\FBCC_20210110.txt";
