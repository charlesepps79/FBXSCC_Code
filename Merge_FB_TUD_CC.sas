...
%LET FINAL_EXPORT_HH = 
"\\mktg-app01\E\Production\2022\05_May_2022\FBXSCC\5.2\Test_2\FBMO_CC_20220426FINAL_JQ_TEST.txt";
...
data _null_;
	call symput("importFB",
		"WORK.FBXS_CC_20220426FINAL_JQ_TE_0000");
run;

data _null_;
	call symput("importMO",
		"WORK.MOCC_20220426FINAL_JQ_0000");
run;
