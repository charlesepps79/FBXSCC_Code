...
DATA 
	...
	*** ASSIGN DATA FILE MACRO VARIABLE -------------------------- ***;
	...
	CALL SYMPUT ('FINALEXPORTFLAGGED', 
		'\\mktg-app01\E\Production\2020\02_February_2020\FBXSCC\FBXS_CC_20200203FLAGGED.txt');
	CALL SYMPUT ('FINALEXPORTDROPPED', 
		'\\mktg-app01\E\Production\2020\02_February_2020\FBXSCC\FBXS_CC_20200203FINAL.txt');
	CALL SYMPUT ('EXPORTMLA', 
		'\\mktg-app01\E\Production\MLA\MLA-INPUT FILES TO WEBSITE\FBCC_20200203.txt');
	CALL SYMPUT ('FINALEXPORTED', 
		'\\mktg-app01\E\Production\2020\02_February_2020\FBXSCC\FBXS_CC_20200203FINAL_HH.cSv');
...
PROC IMPORT 
	DATAFILE = 
		"\\mktg-app01\E\Production\2020\02_February_2020\FBXSCC\XS_Mail_PULL.xlsx" 
...
DATA TEMP;
	SET dw.vw_loan(
		...
		WHERE = (POCD = '13' AND POFFDATE > "&_18MONTH"));
...
DATA _NULL_;
	SET FINALMLA;
	FILE "\\mktg-app01\E\Production\MLA\MLA-INput files TO WEBSITE\FBCC_20200203.txt";
...
FILENAME MLA1
"\\mktg-app01\E\Production\MLA\MLA-Output files FROM WEBSITE\MLA_5_3_FBCC_20200203.txt";
...
PROC IMPORT 
	DATAFILE = 
	"\\mktg-app01\E\Production\Master Files and Instructions\FBXSMOCC_Offers -20191030.xlSx" /*"Change02032020"*/ 
