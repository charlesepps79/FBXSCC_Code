DATA 
	_NULL_;
	CALL SYMPUT ('_1DAY','2019-09-15'); /* DAY BEFORE PULL */
	CALL SYMPUT ('_1MONTH','2019-08-16'); /* 1 MONTH FROM PULL */
	CALL SYMPUT ('_30MONTH','2017-03-17'); /*30 MONTHS FROM PULL*/
	CALL SYMPUT ('_3YR','2016-09-16'); /* 3 YEARS FROM PULL */
	CALL SYMPUT ('_5YR','2014-09-17'); /* 5 YEARS FROM PULL */
	CALL SYMPUT ('_15MONTH','2018-06-16'); /*15 MONTHS FROM PULL*/
RUN;
...
DATA 
	...
	*** ASSIGN ID MACRO VARIABLES -------------------------------- ***;
	CALL SYMPUT ('RETAIL_ID', 'RetailXS_10.1_2019');
	CALL SYMPUT ('AUTO_ID', 'AUTOXS_10.1_2019');
	CALL SYMPUT ('FB_ID', 'FB_10.1_2019CC');
	...
	*** ASSIGN DATA FILE MACRO VARIABLE -------------------------- ***;
	...
	CALL SYMPUT ('FINALEXPORTFLAGGED', 
		'\\mktg-app01\E\Production\2019\10_OCTOBER_2019\FBXSCC\FBXS_CC_20190916FLAGGED.txt');
	CALL SYMPUT ('FINALEXPORTDROPPED', 
		'\\mktg-app01\E\Production\2019\10_OCTOBER_2019\FBXSCC\FBXS_CC_20190916FINAL.txt');
	CALL SYMPUT ('EXPORTMLA', 
		'\\mktg-app01\E\Production\MLA\MLA-INPUT FILES TO WEBSITE\FBCC_20190916.txt');
	CALL SYMPUT ('FINALEXPORTED', 
		'\\mktg-app01\E\Production\2019\10_OCTOBER_2019\FBXSCC\FBXS_CC_20190916FINAL_HH.cSv');
...
DATA _NULL_;
	SET FINALMLA;
	FILE "\\mktg-app01\E\Production\MLA\MLA-INput files TO WEBSITE\FBCC_20190916.txt";
...
FILENAME MLA1
"\\mktg-app01\E\Production\MLA\MLA-Output files FROM WEBSITE\MLA_5_0_FBCC_20190916.txt";
