...
DATA 
	_NULL_;
	CALL SYMPUT ('_1DAY','2019-05-14'); /* DAY BEFORE PULL */
	CALL SYMPUT ('_1MONTH','2019-04-14'); /* 1 MONTH FROM PULL */
	CALL SYMPUT ('_30MONTH','2016-11-13'); /*30 MONTHS FROM PULL*/
	CALL SYMPUT ('_3YR','2016-05-15'); /* 3 YEARS FROM PULL */
	CALL SYMPUT ('_5YR','2014-05-16'); /* 5 YEARS FROM PULL */
	CALL SYMPUT ('_15MONTH','2018-02-12'); /*15 MONTHS FROM PULL*/
RUN;
...
DATA 
	...
	*** ASSIGN ID MACRO VARIABLES -------------------------------- ***;
	CALL SYMPUT ('RETAIL_ID', 'RetailXS_5.2_2019');
	CALL SYMPUT ('AUTO_ID', 'AUTOXS_5.2_2019');
	CALL SYMPUT ('FB_ID', 'FB_5.2_2019CC');
	...
	*** ASSIGN DATA FILE MACRO VARIABLE -------------------------- ***;
	...
	CALL SYMPUT ('FINALEXPORTFLAGGED', 
		'\\mktg-app01\E\Production\2019\05_MAY_2019\FBXSCC\FBXS_CC_20190515FLAGGED.txt');
	CALL SYMPUT ('FINALEXPORTDROPPED', 
		'\\mktg-app01\E\Production\2019\05_MAY_2019\FBXSCC\FBXS_CC_20190515FINAL.txt');
	CALL SYMPUT ('EXPORTMLA', 
		'\\mktg-app01\E\Production\MLA\MLA-INPUT FILES TO WEBSITE\FBCC_20190515.txt');
	CALL SYMPUT ('FINALEXPORTED', 
		'\\mktg-app01\E\Production\2019\05_MAY_2019\FBXSCC\FBXS_CC_20190515FINAL_HH.cSv');
	CALL SYMPUT ('FINALEXPORTHH', 
		'\\mktg-app01\E\Production\2019\05_MAY_2019\FBXSCC\FBXS_CC_20190515FINAL_HH.txt');
RUN;
...
DATA _NULL_;
	SET FINALMLA;
	FILE "\\mktg-app01\E\Production\MLA\MLA-INput files TO WEBSITE\FBCC_20190515.txt";
...
FILENAME MLA1
"\\mktg-app01\E\Production\MLA\MLA-Output files FROM WEBSITE\MLA_4_9_FBCC_20190515.txt";
