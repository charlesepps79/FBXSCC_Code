DATA 
	_NULL_;
	CALL SYMPUT ('_1DAY','2019-10-31'); /* DAY BEFORE PULL */
	CALL SYMPUT ('_1MONTH','2019-10-01'); /* 1 MONTH FROM PULL */
	CALL SYMPUT ('_30MONTH','2017-05-02'); /*30 MONTHS FROM PULL*/
	CALL SYMPUT ('_3YR','2016-11-01'); /* 3 YEARS FROM PULL */
	CALL SYMPUT ('_5YR','2014-11-02'); /* 5 YEARS FROM PULL */
	CALL SYMPUT ('_15MONTH','2018-08-01'); /*15 MONTHS FROM PULL*/
RUN;
...
DATA 
	...
	*** ASSIGN ID MACRO VARIABLES -------------------------------- ***;
	CALL SYMPUT ('RETAIL_ID', 'RetailXS_11.0_2019');
	CALL SYMPUT ('AUTO_ID', 'AUTOXS_11.0_2019');
	CALL SYMPUT ('FB_ID', 'FB_11.0_2019CC');
	...
	*** ASSIGN DATA FILE MACRO VARIABLE -------------------------- ***;
	...
	CALL SYMPUT ('FINALEXPORTFLAGGED', 
		'\\mktg-app01\E\Production\2019\11_NOVEMBER_2019\FBXSCC\FBXS_CC_20191101FLAGGED.txt');
	CALL SYMPUT ('FINALEXPORTDROPPED', 
		'\\mktg-app01\E\Production\2019\11_NOVEMBER_2019\FBXSCC\FBXS_CC_20191101FINAL.txt');
	CALL SYMPUT ('EXPORTMLA', 
		'\\mktg-app01\E\Production\MLA\MLA-INPUT FILES TO WEBSITE\FBCC_20191101.txt');
	CALL SYMPUT ('FINALEXPORTED', 
		'\\mktg-app01\E\Production\2019\11_NOVEMBER_2019\FBXSCC\FBXS_CC_20191101FINAL_HH.cSv');
...
PROC IMPORT 
	DATAFILE = 
		"\\mktg-app01\E\Production\2019\11_NOVEMBER_2019\FBXSCC\XS_Mail_PULL.xlsx" 
...
DATA _NULL_;
	SET FINALMLA;
	FILE "\\mktg-app01\E\Production\MLA\MLA-INput files TO WEBSITE\FBCC_20191101.txt";
...
FILENAME MLA1
"\\mktg-app01\E\Production\MLA\MLA-Output files FROM WEBSITE\MLA_5_1_FBCC_20191101.txt";
