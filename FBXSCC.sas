...
DATA 
	_NULL_;
	CALL SYMPUT ('_1DAY','2019-07-01'); /* DAY BEFORE PULL */
	CALL SYMPUT ('_1MONTH','2019-06-01'); /* 1 MONTH FROM PULL */
	CALL SYMPUT ('_30MONTH','2016-12-31'); /*30 MONTHS FROM PULL*/
	CALL SYMPUT ('_3YR','2016-07-02'); /* 3 YEARS FROM PULL */
	CALL SYMPUT ('_5YR','2014-07-03'); /* 5 YEARS FROM PULL */
	CALL SYMPUT ('_15MONTH','2018-04-01'); /*15 MONTHS FROM PULL*/
RUN;
...
DATA 
	...
	*** ASSIGN ID MACRO VARIABLES -------------------------------- ***;
	CALL SYMPUT ('RETAIL_ID', 'RetailXS_7.0_2019');
	CALL SYMPUT ('AUTO_ID', 'AUTOXS_7.0_2019');
	CALL SYMPUT ('FB_ID', 'FB_7.0_2019CC');
	...
	*** ASSIGN DATA FILE MACRO VARIABLE -------------------------- ***;
	...
	CALL SYMPUT ('FINALEXPORTFLAGGED', 
		'\\mktg-app01\E\Production\2019\07_JULY_2019\FBXSCC\FBXS_CC_20190702FLAGGED.txt');
	CALL SYMPUT ('FINALEXPORTDROPPED', 
		'\\mktg-app01\E\Production\2019\07_JULY_2019\FBXSCC\FBXS_CC_20190702FINAL.txt');
	CALL SYMPUT ('EXPORTMLA', 
		'\\mktg-app01\E\Production\MLA\MLA-INPUT FILES TO WEBSITE\FBCC_20190702.txt');
	CALL SYMPUT ('FINALEXPORTED', 
		'\\mktg-app01\E\Production\2019\07_JULY_2019\FBXSCC\FBXS_CC_20190702FINAL_HH.cSv');
...
PROC IMPORT 
	DATAFILE = 
		"\\mktg-app01\E\Production\2019\07_JULY_2019\FBXSCC\XS_Mail_PULL.xlsx" 
...
DATA _NULL_;
	SET FINALMLA;
	FILE "\\mktg-app01\E\Production\MLA\MLA-INput files TO WEBSITE\FBCC_20190702.txt";
...
PROC IMPORT 
	DATAFILE = 
	"\\mktg-app01\E\Production\Master Files and Instructions\FBXSCC_Offers -20190514.xlSx" 
