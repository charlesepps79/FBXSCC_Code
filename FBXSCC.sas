...
DATA 
	...
	CALL SYMPUT ('_30MONTH','2017-01-24'); /*30 MONTHS FROM PULL*/
	CALL SYMPUT ('_3YR','2016-07-26'); /* 3 YEARS FROM PULL */
	CALL SYMPUT ('_5YR','2014-07-27'); /* 5 YEARS FROM PULL */
	CALL SYMPUT ('_15MONTH','2018-04-25'); /*15 MONTHS FROM PULL*/
RUN;
...
DATA 
	...
	*** ASSIGN ID MACRO VARIABLES -------------------------------- ***;
	CALL SYMPUT ('RETAIL_ID', 'RetailXS_8.0_2019');
	CALL SYMPUT ('AUTO_ID', 'AUTOXS_8.0_2019');
	...
	*** ASSIGN DATA FILE MACRO VARIABLE -------------------------- ***;
	...
	CALL SYMPUT ('FINALEXPORTFLAGGED', 
		'\\mktg-app01\E\Production\2019\08_AUGUST_2019\FBXSCC\FBXS_CC_20190726FLAGGED.txt');
	CALL SYMPUT ('FINALEXPORTDROPPED', 
		'\\mktg-app01\E\Production\2019\08_AUGUST_2019\FBXSCC\FBXS_CC_20190726FINAL.txt');
	CALL SYMPUT ('EXPORTMLA', 
		'\\mktg-app01\E\Production\MLA\MLA-INPUT FILES TO WEBSITE\FBCC_20190726.txt');
	CALL SYMPUT ('FINALEXPORTED', 
		'\\mktg-app01\E\Production\2019\08_AUGUST_2019\FBXSCC\FBXS_CC_20190726FINAL_HH.cSv');
...
PROC IMPORT 
	DATAFILE = 
		"\\mktg-app01\E\Production\2019\08_AUGUST_2019\FBXSCC\XS_Mail_PULL.xlsx" 
...
DATA _NULL_;
	SET FINALMLA;
	FILE "\\mktg-app01\E\Production\MLA\MLA-INput files TO WEBSITE\FBCC_20190726.txt";
