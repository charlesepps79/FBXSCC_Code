...
DATA 
	...
	CALL SYMPUT ('_1DAY','2018-05-13'); /* DAY BEFORE PULL */
	CALL SYMPUT ('_1MONTH','2018-04-13'); /* 1 MONTH FROM PULL */
	CALL SYMPUT ('_30MONTH','2015-11-13'); /*30 MONTHS FROM PULL*/
	CALL SYMPUT('_3YR','2015-05-15'); /* 3 YEARS FROM PULL */
	CALL SYMPUT('_5YR','2013-05-15'); /* 5 YEARS FROM PULL */
	CALL SYMPUT ('_15MONTH','2017-02-11'); /*15 MONTHS FROM PULL*/

	*** ASSIGN ID MACRO VARIABLES -------------------------------- ***;
	CALL SYMPUT ('RETAIL_ID', 'RetailXS_6.0_2018');
	CALL SYMPUT ('AUTO_ID', 'AUTOXS_6.0_2018');
	CALL SYMPUT ('FB_ID', 'FB_6.0_2018CC');
	...
	*/
	...
	CALL SYMPUT ('FINALEXPORTFLAGGED', 
		'\\mktg-app01\E\cepps\FBXS\FILEs\2018_05_14\FBXS_CC_.20180514FLAGGED.txt');
	CALL SYMPUT ('FINALEXPORTDROPPED', 
		'\\mktg-app01\E\cepps\FBXS\FILEs\2018_05_14\FBXS_CC_20180514FINAL.txt');
	CALL SYMPUT ('EXPORTMLA', 
		'\\mktg-app01\E\cepps\FBXS\FILEs\2018_05_14\FBCC_20180514.txt');
	CALL SYMPUT ('FINALEXPORTED', 
		'\\mktg-app01\E\cepps\FBXS\FILEs\2018_05_14\FBXS_CC_20180514FINAL_HH.csv');
	CALL SYMPUT ('FINALEXPORTHH', 
		'\\mktg-app01\E\cepps\FBXS\FILEs\2018_05_14\FBXS_CC_20180514FINAL_HH.txt');
RUN;
...
PROC IMPORT 
	DATAFILE = 
	"\\mktg-app01\E\Production\Master Files and Instructions\FBXSCC_OFFERS - 20180424.xlSx" 
