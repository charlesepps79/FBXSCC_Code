...
DATA 
	...
	CALL SYMPUT ('_1DAY','2018-07-19'); /* DAY BEFORE PULL */
	CALL SYMPUT ('_1MONTH','2018-06-19'); /* 1 MONTH FROM PULL */
	CALL SYMPUT ('_30MONTH','2016-01-19'); /*30 MONTHS FROM PULL*/
	CALL SYMPUT('_3YR','2015-07-21'); /* 3 YEARS FROM PULL */
	CALL SYMPUT('_5YR','2013-07-21'); /* 5 YEARS FROM PULL */
	CALL SYMPUT ('_15MONTH','2017-04-19'); /*15 MONTHS FROM PULL*/

	*** ASSIGN ID MACRO VARIABLES -------------------------------- ***;
	CALL SYMPUT ('RETAIL_ID', 'RetailXS_8.1_2018');
	CALL SYMPUT ('AUTO_ID', 'AUTOXS_8.1_2018');
	CALL SYMPUT ('FB_ID', 'FB_8.1_2018CC');
	...
	*** ASSIGN DATA FILE MACRO VARIABLE -------------------------- ***;
	...
	CALL SYMPUT ('FINALEXPORTFLAGGED', 
		'\\mktg-app01\E\Production\2018\08-August_2018\FBXSCC\FBXS_CC_20180720FLAGGED.txt');
	CALL SYMPUT ('FINALEXPORTDROPPED', 
		'\\mktg-app01\E\Production\2018\08-August_2018\FBXSCC\FBXS_CC_20180720FINAL.txt');
	CALL SYMPUT ('EXPORTMLA', 
		'\\mktg-app01\E\Production\MLA\MLA-INPUT FILES TO WEBSITE\FBCC_20180720.txt');
	CALL SYMPUT ('FINALEXPORTED', 
		'\\mktg-app01\E\Production\2018\08-August_2018\FBXSCC\FBXS_CC_20180720FINAL_HH.cSv');
	CALL SYMPUT ('FINALEXPORTHH', 
		'\\mktg-app01\E\Production\2018\08-August_2018\FBXSCC\FBXS_CC_20180720FINAL_HH.txt');
RUN;
...
FILENAME MLA1
"\\mktg-app01\E\Production\MLA\MLA-Output files FROM WEBSITE\MLA_4_5_FBCC_20180720.txt";
